...
function displayBeer() {
    ...
    const beerContainer = document.getElementById('beerContainer'); // Replace 'beerContainer' with the actual ID of the container div
...
function getBeerDetails(beerID) {
    /* Speichern Sie das Objekt aus der fullBeerList an der Stelle der ID die als Übergabeparameter
       ...
       const beer = fullBeerList[beerID]
